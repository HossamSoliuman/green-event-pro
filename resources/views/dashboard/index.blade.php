    ...
    <div class="card p-4 sm:p-6">
        <div class="flex items-start sm:items-center justify-between gap-4 flex-col sm:flex-row">
            <div class="min-w-0">
                ...
                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">{{ $totalEvents }}</p>
            </div>
    ...
    <div class="card p-4 sm:p-6">
        <div class="flex items-start sm:items-center justify-between gap-4 flex-col sm:flex-row">
            <div class="min-w-0">
                ...
                <p class="text-2xl sm:text-3xl font-bold text-green-600 mt-1">{{ $certifiedEvents }}</p>
            </div>
    ...
    <div class="card p-4 sm:p-6">
        <div class="flex items-start sm:items-center justify-between gap-4 flex-col sm:flex-row">
            <div class="min-w-0">
                ...
                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">{{ number_format($totalCo2 / 1000, 1) }}<span class="text-sm sm:text-base font-medium text-gray-500 ml-1">t</span></p>
            </div>
    ...
    <div class="card p-4 sm:p-6">
        <div class="flex items-start sm:items-center justify-between gap-4 flex-col sm:flex-row">
            <div class="min-w-0">
                ...
                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">{{ $avgScore ? number_format($avgScore, 1) : '–' }}<span class="text-sm sm:text-base font-medium text-gray-500 ml-1">%</span></p>
            </div>
...
<div class="card p-4 sm:p-6">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4">
        ...
        <a href="{{ route('events.index') }}" class="text-sm text-green-600 hover:text-green-700 font-medium whitespace-nowrap">{{ __('Show all') }} &rarr;</a>
    </div>
    @if($events->isEmpty())
    ...
    @else
        <div class="overflow-x-auto -mx-6 -mb-6 sm:mx-0 sm:mb-0">
            <div class="inline-block min-w-full px-6 sm:px-0">
                <table class="w-full text-sm">
                    <thead>
                        <tr class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-100">
                            ...
                            <th class="pb-3 pr-4 hidden sm:table-cell">{{ __('Participants') }}</th>
                            <th class="pb-3 pr-4 hidden md:table-cell">UZ 62</th>
                            <th class="pb-3 pr-4 hidden lg:table-cell">CO₂/P</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-3 pr-4 text-gray-600 hidden sm:table-cell">{{ number_format($event->expected_participants) }}</td>
                            ...
                            <td class="py-3 pr-4 text-gray-600 hidden lg:table-cell">
