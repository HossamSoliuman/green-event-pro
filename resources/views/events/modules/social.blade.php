@extends('layouts.app')
@section('title', ucfirst('social').' – '.$event->title)
@section('page-title', 'Modul: '.ucfirst(str_replace('_',' ','social')))
@section('content')
<div class="mb-4">
...
<form method="POST" action="{{ route('events.modules.social.update', $event) }}">
    ...
    <div class="card space-y-4">
        <h3 class="section-title">{{ ucfirst(str_replace('_',' ','social')) }} Daten</h3>
