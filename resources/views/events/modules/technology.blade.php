@extends('layouts.app')
@section('title', __('module.technology') . ' – ' . $event->title)
@section('page-title', __('Module') . ': ' . __('module.technology'))
@section('content')
    <div class="mb-4">
    ...
    <form method="POST" action="{{ route('events.modules.technology.update', $event) }}">
        ...
        <div class="card space-y-4">
            <h3 class="section-title">{{ __('module.technology') }} {{ __('module_data') }}</h3>
