@extends('layouts.app')
@section('title', __('module.procurement') . ' – ' . $event->title)
@section('page-title', __('Module') . ': ' . __('module.procurement'))
@section('content')
    <div class="mb-4">
    ...
    <form method="POST" action="{{ route('events.modules.procurement.update', $event) }}">
        ...
        <div class="card space-y-4">
            <h3 class="section-title">{{ __('module.procurement') }} {{ __('module_data') }}</h3>
