@extends('layouts.app')
@section('title', __('module.tv_production') . ' – ' . $event->title)
@section('page-title', __('Module') . ': ' . __('module.tv_production'))
@section('content')
    <div class="mb-4">
    ...
    <form method="POST" action="{{ route('events.modules.tv_production.update', $event) }}">
        ...
        <div class="card space-y-4">
            <h3 class="section-title">{{ __('module.tv_production') }} {{ __('module_data') }}</h3>
