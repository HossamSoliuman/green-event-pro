@extends('layouts.app')
@section('title', __('module.communication') . ' – ' . $event->title)
@section('page-title', __('Module') . ': ' . __('module.communication'))
@section('content')
    <div class="mb-4">
    ...
    <form method="POST" action="{{ route('events.modules.communication.update', $event) }}">
        ...
        <div class="card space-y-4">
            <h3 class="section-title">{{ __('module.communication') }} {{ __('module_data') }}</h3>
