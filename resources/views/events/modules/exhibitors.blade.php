@extends('layouts.app')
@section('title', __('module.exhibitors') . ' – ' . $event->title)
@section('page-title', __('Module') . ': ' . __('module.exhibitors'))
@section('content')
    <div class="mb-4">
    ...
    <form method="POST" action="{{ route('events.modules.exhibitors.update', $event) }}">
        ...
        <div class="card space-y-4">
            <h3 class="section-title">{{ __('module.exhibitors') }} {{ __('module_data') }}</h3>
