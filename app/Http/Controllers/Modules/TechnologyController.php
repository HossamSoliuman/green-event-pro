...
use App\Models\EventTechnology;
...
class TechnologyController extends Controller
{
    public function edit(Event $event)
    {
        ...
        $module = EventTechnology::firstOrNew([
            'event_id' => $event->id,
            'organization_id' => $event->organization_id,
        ]);
        $view = strtolower(preg_replace('/(?<!^)[A-Z]/', '_$0', 'Technology'));
    ...
    public function update(Request $request, Event $event)
    {
        ...
        EventTechnology::updateOrCreate(['event_id' => $event->id], $data);
