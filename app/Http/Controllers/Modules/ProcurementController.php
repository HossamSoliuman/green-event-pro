...
use App\Models\EventProcurement;
...
class ProcurementController extends Controller
{
    public function edit(Event $event)
    {
        ...
        $module = EventProcurement::firstOrNew([
            'event_id' => $event->id,
            'organization_id' => $event->organization_id,
        ]);
        $view = strtolower(preg_replace('/(?<!^)[A-Z]/', '_$0', 'Procurement'));
    ...
    public function update(Request $request, Event $event)
    {
        ...
        EventProcurement::updateOrCreate(['event_id' => $event->id], $data);
